...
func getCustomerInfoList() map[string]CustomerInfo {
	...
	customerInfoList := [][]string{
		...
		[]string{"古月林夕", "wechat", "owFDXszUEtoctweeTHhkR0S5iGqg"},
		[]string{"胡梦", "alipay", "20880073781135861323831830011664"},
		// []string{"", "site", "1d3376ae060eeb8027422e141e446e70af8235101c3d89e44f2a4f6e701cb941"},
		// []string{"七月里的五月天", "wechat", "owFDXsxpkZJT-rqnx3Y5kP3RCXQE"},
		...
		//[]string{"杨冬燕", "wechat", "owFDXs0V2CfaSB8ION2l0o63NhCw"},
	...
	for _, v := range customerInfoList {
		...
		if err, key = c.GetKey(); err == nil { //correct
			customerInfo[key] = c
		}
	}
	return customerInfo
